...
<div id="wrapper">
  ...
  <? 
  	if ($query->num_rows() > 0)
  	{
  	   ...
  	   {
  ?>
  <?echo form_open('presentation/edit_entry/');?>
  	...
  	<section id="landing">
  	 <img src="http://thecreatatory.com/gms/images/bottom_tab.jpg" alt="" class="bottom_tab" />
  	 	...
  	 	<article class="bottom">
  	 		...
  	 		<h3 class="white_header"><input type="text" name="prepared_for" value="<?= $row->prepared_for ?>" /></h3>
  	 		<div id="sales_rep">
  	 			<h3 class="green_header"><input type="text" name="sales_rep" value="<?= $row->sales_rep ?>" /></h3>
  	 		</div>
  	 	</article>
  	 	<!-- end footer-->
  	 </section>
  	 ...
  	 <h4 class="gray_tab">GMS Menu oF ServiceS - overview</h4>
  	 	...
  	 	<article style="margin:50px 0 0 0">
  	 		<div class="rounded">
  	 			...
  	 			<input type="number" name="current_payroll_processing" value="<?= $row->current_payroll_processing ?>" />
  	 		</div>
  	 		<div class="spacer">
  	 			<div class="plus">+</div>
  	 		</div>
  	 		<div class="rounded">
  	 			...
  	 			<input type="number" name="accountant_fees_eliminated" value="<?= $row->accountant_fees_eliminated ?>" />
  	 		</div>
  	 		<div class="spacer">
  	 			<div class="plus">+</div>
  	 		</div>
  	 		<div class="rounded">
  	 			...
  	 			<input type="number" name="additional_items" value="<?= $row->additional_items ?>" />
  	 		</div>
  	 		<div class="spacer">
  	 			<div class="equal">=</div>
  	 		</div>
  	 ...
  	 <h4 class="gray_tab">GMS Menu oF ServiceS - overview</h4>
  	 	...
  	 	<article style="margin:70px 0 0 0">
  	 		<div class="rounded">
  	 			...
  	 			<input type="number" name="gms_healthcare_plan_1" value="<?= $row->gms_healthcare_plan_1 ?>" />
  	 		</div>
  	 		<div class="spacer">
  	 		...
  	 		<div class="rounded">
  	 			...
  	 			<input type="number" name="gms_healthcare_plan_2" value="<?= $row->gms_healthcare_plan_2 ?>" />
  	 		</div>
  	 		<div class="spacer">
  	 		...
  	 		<div class="rounded">
  	 			...
  	 			<input type="number" name="current_healthcare_ann_premium" value="<?= $row->current_healthcare_ann_premium ?>" />
  	 		</div>
  	 	...
  	 	<div class="spacer">
  	 		...
  	 		<div class="rounded">
  	 			...
  	 			<input type="number" name="admin_fee_eliminated" value="<?= $row->admin_fee_eliminated ?>" />
  	 		</div>
  	 		<div class="spacer">
  	 			<div class="plus" >+</div>
  	 		</div>
  	 		<div class="rounded">
  	 			...
  	 			<input type="number" name="benefit_additional_items" value="<?= $row->benefit_additional_items ?>" />
  	 		</div>
  	 		<div class="spacer">
  	 			<div class="equal" >=</div>
  	 		</div>
  	 ...
  	 <h4 class="gray_tab">GMS Menu oF ServiceS - overview</h4>
  	 	...
  	 	<article class="totals" style="margin:20px 0 0 0">
  	 		<div class="rounded small first height">
  	 			...
  	 			<?$man_class = json_decode($row->man_class);?>
  	 				<li><input type="number" name="man_class[]" value="<?= $man_class[0] ?>" /></li>
  	 				<li><input type="number" name="man_class[]" value="<?= $man_class[1] ?>" /></li>
  	 				<li><input type="number" name="man_class[]" value="<?= $man_class[2] ?>" /></li>
  	 				<li><input type="number" name="man_class[]" value="<?= $man_class[3] ?>" /></li>
  	 				<li><input type="number" name="man_class[]" value="<?= $man_class[4] ?>" /></li>
  	 				<li>Totals</li>
  	 			</ul>
  	 		</div>
  	 		...
  	 		<div class="rounded small height">
  	 			...
  	 			<li><input type="number" name="payroll[]" value="<?= $payroll[0] ?>" /></li>
  	 			<li><input type="number" name="payroll[]" value="<?= $payroll[1] ?>" /></li>
  	 			<li><input type="number" name="payroll[]" value="<?= $payroll[2] ?>" /></li>
  	 			<li><input type="number" name="payroll[]" value="<?= $payroll[3] ?>" /></li>
  	 			<li><input type="number" name="payroll[]" value="<?= $payroll[4] ?>" /></li>
  	 			<li>----</li>
  	 			</ul>
  	 		</div>
  	 		...
  	 		<div class="rounded small height">
  	 			...
  	 			<li><input type="number" name="current_rate[]" value="<?= $current_rate[0] ?>" /></li>
  	 			<li><input type="number" name="current_rate[]" value="<?= $current_rate[1] ?>" /></li>
  	 			<li><input type="number" name="current_rate[]" value="<?= $current_rate[2] ?>" /></li>
  	 			<li><input type="number" name="current_rate[]" value="<?= $current_rate[3] ?>" /></li>
  	 			<li><input type="number" name="current_rate[]" value="<?= $current_rate[4] ?>" /></li>
  	 			<li>----</li>
  	 			</ul>
  	 		</div>
  	 		...
  	 		<div class="rounded small height">
  	 			...
  	 			<?$current_premium = json_decode($row->current_premium);?>
  	 				<li><input type="number" name="current_premium[]" value="<?= $current_premium[0] ?>" /></li>
  	 				<li><input type="number" name="current_premium[]" value="<?= $current_premium[1] ?>" /></li> 
  	 				<li><input type="number" name="current_premium[]" value="<?= $current_premium[2] ?>" /></li> 
  	 				<li><input type="number" name="current_premium[]" value="<?= $current_premium[3] ?>" /></li>
  	 				<li><input type="number" name="current_premium[]" value="<?= $current_premium[4] ?>" /></li>
  	 				<li>----</li>
  	 			</ul>
  	 		</div>
  	 		...
  	 		<div class="rounded small height">
  	 			...
  	 			<?$gms_rate = json_decode($row->gms_rate);?>
  	 				<li><input type="number" name="gms_rate[]" value="<?= $gms_rate[0] ?>" /></li>
  	 				<li><input type="number" name="gms_rate[]" value="<?= $gms_rate[1] ?>"  /></li>
  	 				<li><input type="number" name="gms_rate[]" value="<?= $gms_rate[2] ?>"  /></li> 
  	 				<li><input type="number" name="gms_rate[]" value="<?= $gms_rate[3] ?>"  /> </li>
  	 				<li><input type="number" name="gms_rate[]" value="<?= $gms_rate[4] ?>"  /></li>
  	 				<li>----</li>
  	 			</ul>
  	 		</div>
  	 		...
  	 		<div class="rounded small height">
  	 			...
  	 			<li><input type="number" name="gms_premium[]" value="<?= $gms_premium[0] ?>"  /></li>
  	 			<li><input type="number" name="gms_premium[]" value="<?= $gms_premium[1] ?>" /></li> 
  	 			<li><input type="number" name="gms_premium[]" value="<?= $gms_premium[2] ?>" /></li> 
  	 			<li><input type="number" name="gms_premium[]" value="<?= $gms_premium[3] ?>" /></li> 
  	 			<li><input type="number" name="gms_premium[]" value="<?= $gms_premium[4] ?>" /></li>
  	 			<li>----</li>
  	 			</ul>
  	 		</div>
  	 	...
  	 	<div class="rounded small" style="float:right">
  	 	 			...
  	 	 			<ul>
  	 	 				<li><input type="number" name="tpa_fee" value="<?= $row->tpa_fee ?>" /></li>
  	 	 				<li><input type="number" name="unemployment_savings" value="<?= $row->unemployment_savings ?>" /></li>
  	 	 				<li><input type="number" name="drug_free_program" value="<?= $row->drug_free_program ?>" /></li>
  	 	 				<li><input type="number" name="drug_free_training" value="<?= $row->drug_free_training ?>" /></li>
  	 	 			</ul>
  	 	 		</div>
  	  ...
  	  <h4 class="gray_tab">GMS Menu oF ServiceS - overview</h4>
  	  	...
  	  	<article style="margin:50px 0 0 0">
  	  		<div class="rounded">
  	  			...
  	  			<input type="number" name="average_sallary_per_100" value="<?= $row->average_sallary_per_100 ?>" />
  	  		</div>
  	  		<div class="spacer">
  	  			<div class="plus">+</div>
  	  		</div>
  	  		<div class="rounded">
  	  			...
  	  			<input type="number" name="cost_per_employee" value="<?= $row->cost_per_employee ?>" />
  	  		</div>
  	  		<div class="spacer">
  	  			<div class="plus">+</div>
  	  		</div>
  	  		<div class="rounded">
  	  			...
  	  			<input type="number" name="number_of_employees" value="<?= $row->number_of_employees ?>" />
  	  		</div>
  	  		<div class="spacer">
  	  			<div class="equal">=</div>
  	  		</div>
  	  ...
  	  <h4 class="gray_tab">GMS Menu oF ServiceS - overview</h4>
  	  	...
  	  	<div style="float:left; width: 500px;">
  	  		...
  	  		<div class="rounded small" style="height:150px">
  	  			...
  	  			<input type="number" name="set_up_fee" value="<?= $row->set_up_fee ?>" />
  	  		</div>
  	  		<div class="rounded small" style="height:150px">
  	  			<div class="rounded green ">
  	  				<h3 class="white_header">Admin Fee</h3>
  	  			</div>
  	  			<input type="number" name="admin_fee" value="<?= $row->admin_fee ?>" />
  	  		</div>
  	  		<div class="spacer">
  	  		...
  	  		<div class="rounded small" style="height:150px">
  	  			...
  	  			<input type="number" name="gross_wages" value="<?= $row->gross_wages ?>" />
  	  		</div>
